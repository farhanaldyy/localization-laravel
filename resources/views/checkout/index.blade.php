			...
			<div class="row g-5">
				...
				<div class="col-md-7 col-lg-8">
					<div class="d-flex justify-content-between">
						<h4 class="mb-3">{{__('Billing address', ['name' => 'Farhan'])}}</h4>
						<div class="dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
								...
								<li><a class="dropdown-item" href="{{url('/jp/checkout')}}">JP</a></li>
							</ul>
						</div>
					</div>
					<form class="needs-validation" novalidate>
						<div class="row g-3">
							<div class="col-sm-6">
								<label for="firstName" class="form-label">{{__('form.first_name')}}</label>
							...
							<div class="col-sm-6">
								<label for="lastName" class="form-label">{{__('form.last_name')}}</label>
							...
							<div class="col-12">
								<label for="username" class="form-label">{{__('form.username')}}</label>
							...
							<div class="col-12">
								<label for="email" class="form-label">@lang('form.email')</label>
							...
							<div class="col-12">
								<label for="address2" class="form-label">@lang('form.address2')</label>
						...
						<div class="row gy-3">
							<div class="col-md-6">
								...
								<small class="text-body-secondary">{{__('Full name as displayed on card')}}</small>
								<div class="invalid-feedback">
